...
```bash
qa batch my-images              # by default look for images
qa --type movie batch my-movies  # here we look for movies
```

And finally in `run()` you can:
...
This feature is used to build common needs like "pipelines".
