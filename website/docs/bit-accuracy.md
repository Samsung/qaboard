...
- The latest results on `project.reference_branch` from [*qatools.yaml*](http://gitlab-srv/common-infrastructure/qatools/blob/master/qatools/sample_project/qatools.yaml) (default: *master*).
...
Files matching the patterns defined as `bit-accuracy.patterns` in [*qatools.yaml*](http://gitlab-srv/common-infrastructure/qatools/blob/master/qatools/sample_project/qatools.yaml#L93) will be checked.
