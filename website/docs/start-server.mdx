...
**SIRC:**
```bash
docker compose -f docker-compose.yml -f production.yml -f deployments/sirc.yml up -d
```

**DSK:**
```bash
docker compose -f docker-compose.yml -f production.yml -f deployments/dsk.yml up -d
```
