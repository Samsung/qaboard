    ...
    return <>
        ...
        <Popover hoverCloseDelay={500} interactionKind={"hover"} inheritDarkTheme portalClassName={Classes.DARK}>
          ...
          <div style={{ padding: '15px' }}>
            <p>Read about <a href="http://www.brendangregg.com/flamegraphs.html"target="_blank">Frame Graphs</a></p>
            <p>And the <a href="http://www.brendangregg.com/blog/2014-11-09/differential-flame-graphs.html"target="_blank">Differential Flame Graphs</a> versions</p>
          </div>
        </Popover>
