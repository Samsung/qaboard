...
class ProjectsList extends Component {
  ...
  render() {
    ...
    const github_cat = <>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#106ba3">
    ...
    return (
      <Container>
        <Navbar style={{ color: Colors.BLUE1, background: "#dcebf5"}}>
            <NavbarGroup align={Alignment.LEFT}>
                <NavbarHeading><b>QA-Board</b></NavbarHeading>
                <NavbarDivider />
                <AnchorButton className={Classes.MINIMAL} icon={github_cat} text="GitHub" href="https://github.com/Samsung/qaboard" style={{color : "#0d4975"}}/>
                <AnchorButton className={Classes.MINIMAL} icon={<Icon icon="document" color="#106ba3"/>} text="Docs" href={`${process.env.REACT_APP_QABOARD_DOCS_ROOT}docs/introduction`} style={{color : "#0d4975"}}/>
            </NavbarGroup>
